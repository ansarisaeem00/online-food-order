...
#mysql_select_db("restraunt", $con);
  ...
  $r=mysqli_query($con,"select *from restraunt.order where uname='". $hnm . "'");
  if((mysqli_num_rows($r))==0){
	  echo "no item";
	  }
  else
  {
	  $result=mysqli_query($con,"select *from restraunt.order where uname='". $hnm . "'");?>
...
$sql="select *from restr aunt where r_id='".$rd."'";
